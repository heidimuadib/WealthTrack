...
export const SERVER_MESSAGE_KEYS = {
    ...
    'Current password is required': 'server.currentPasswordRequired',
    'Current password is incorrect': 'server.currentPasswordIncorrect',
    'New password must be different from the current one': 'server.passwordUnchanged',
    'That reset link is invalid or has expired': 'server.resetLinkInvalid',
